...
const RegisterStudent = () => {
  ...
  const [
    ...
    setFurther_details_About_the_Childs_Health,
  ] = useState('')
  const [
  ...
  const EditStudents = students?.find(
    (student) => student?.student_id === parseInt(id)
  )
  console.log(EditStudents)

  useEffect(() => {
    setFirstname(EditStudents?.firstname)
    setSurname(EditStudents?.Surname)
    setGender(EditStudents?.Gender)
    setDate_Of_Birth(EditStudents?.Date_Of_Birth)
    setplace_Of_Birth(EditStudents?.Place_Of_Birth)
    setMother_Tongue(EditStudents?.Mother_Tongue)
    setReligion_And_Denomination(EditStudents?.Religion_And_Denomination)
    setGhanaian_Language_Spoken(EditStudents?.Ghanaian_Language_Spoken)
    setHome_Town(EditStudents?.Home_Town)
    setNationality(EditStudents?.Nationality)
    setRegion(EditStudents?.Region)
    setYear_In_Which_Admission_Is_Sought(
      EditStudents?.Year_In_Which_Admission_Is_Sought
    )
    setName_Of_School(EditStudents?.Name_Of_School)
    setAdmittion_details(EditStudents?.Admittion_details)
    setLast_Attendance_Date(EditStudents?.Last_Attendance_Date)
    setHow_Did_You_Hear_About_Trinity_Christian_Mission_School(
      EditStudents?.How_Did_You_Hear_About_Trinity_Christian_Mission_School
    )
    setWhat_Are_Your_Reasons_For_Leaving_Your_Previous_School(
      EditStudents?.What_Are_Your_Reasons_For_Leaving_Your_Previous_School
    )
    setBoth_Parents(EditStudents?.Both_Parents)
    setMother(EditStudents?.Mother)
    setFather(EditStudents?.Father)
    setOther_Person(EditStudents?.Other_Person)
    setGuardian(EditStudents?.Guardian)
    setOlder_Children(EditStudents?.Older_Children)
    setYounger_Children(EditStudents?.Younger_Children)
    setDetails_Of_Persons_Relationship_To_The_Child_Living_with(
      EditStudents?.Details_Of_Persons_Relationship_To_The_Child_Living_with
    )
    setfathers_Firstname(EditStudents?.fathers_Firstname)
    setfathers_surname(EditStudents?.fathers_surname)
    setfathers_Occupation(EditStudents?.fathers_Occupation)
    setfathers_Nationality(EditStudents?.fathers_Nationality)
    setfathers_Education_level(EditStudents?.fathers_Education_level)
    setfathers_Religion(EditStudents?.fathers_Religion)
    setfathers_Name_And_Adress_Of_Place_Of_Work(
      EditStudents?.fathers_Name_And_Adress_Of_Place_Of_Work
    )
    setfathers_Home_Address(EditStudents?.fathers_Home_Address)
    setfathers_Tel_Number_Office(EditStudents?.fathers_Tel_Number_Office)
    setfathers_Tel_Number_Mobile(EditStudents?.fathers_Tel_Number_Mobile)
    setfathers_Email_Address(EditStudents?.fathers_Email_Address)
    setfathers_Number_Of_Wifes(EditStudents?.fathers_Number_Of_Wifes)
    setfathers_If_Deceased_State_Date_Of_Death(
      fathers_If_Deceased_State_Date_Of_Death
    )
    setSmallpox(EditStudents?.Smallpox)
    setDiptheria(EditStudents?.Diptheria)
    setWhooping_Cou(EditStudents?.Whooping_Cou)
    setTeta(EditStudents?.Teta)
    setMeasles(EditStudents?.Measles)
    setPolio(EditStudents?.Polio)
    setTuberculosis(EditStudents?.Tuberculosis)
    setFurther_details_About_the_Childs_Health(
      EditStudents?.Futher_details_About_the_Childs_Health
    )
    setIn_Case_Of_Sudden_Illness_At_School_Please_State_What_Should_Be_Done(
      EditStudents?.In_Case_Of_Sudden_Illness_At_School_Please_State_What_Should_Be_Done
    )
    setMother_Firstname(EditStudents?.Mother_Firstname)
    setMother_surname(EditStudents?.Mother_surname)
    setMother_Occupation(EditStudents?.Mother_Occupation)
    setMother_Nationality(EditStudents?.Mother_Nationality)
    setMother_Education_level(EditStudents?.Mother_Education_level)
    setMother_Religion(EditStudents?.Mother_Religion)
    setMother_Name_And_Address_Of_Place_Of_Work(
      EditStudents?.Mother_Name_And_Address_Of_Place_Of_Work
    )
    setMother_Home_Adress(EditStudents?.Mother_Home_Adress)
    setMother_Tel_Number_Office(EditStudents?.Mother_Tel_Number_Office)
    setMother_Tel_Number_Mobile(EditStudents?.Mother_Tel_Number_Mobile)
    setMother_Email_Address(EditStudents?.Mother_Email_Address)
    setMother_If_Deceased_State_Date_Of_Death(
      EditStudents?.Mother_If_Deceased_State_Date_Of_Death
    )
    setGuardian_Firstname(EditStudents?.Guardian_Firstname)
    setGuardian_surname(EditStudents?.Guardian_surname)
    setGuardian_Occupation(EditStudents?.Guardian_Occupation)
    setGuardian_Nationality(EditStudents?.Guardian_Nationality)
    setGuardian_Education_level(EditStudents?.Guardian_Education_level)
    setGuardian_Religion(EditStudents?.Guardian_Religion)
    setGuardian_Name_And_Address_Of_Place_Of_Work(
      EditStudents?.Guardian_Name_And_Address_Of_Place_Of_Work
    )
    setGuardian_Home_Address(EditStudents?.Guardian_Home_Address)
    setGuardian_Tel_Number_Office(EditStudents?.Guardian_Tel_Number_Office)
    setGuardian_Tel_Number_Mobile(EditStudents?.Guardian_Tel_Number_Mobile)
    setGuardian_Email_Address(EditStudents?.Guardian_Email_Address)
    setGuardian_Number_Of_Wifes(EditStudents?.Guardian_Number_Of_Wifes)
    setParents_or_guardian_signature(
      EditStudents?.Parents_or_guardian_signature
    )
    setParentSignedBy(EditStudents?.ParentsignedBy)
    setcorrespondence_No(EditStudents?.correspondence_No)
    setAdmission(EditStudents?.Admission)
    setDate_For_Receipt_Of_Admission_Form(
      EditStudents?.Date_For_Receipt_Of_Admission_Form
    )
    setBirth_CertificateI(EditStudents?.Birth_CertificateI)
    setBirth_CertificateC(EditStudents?.Birth_CertificateC)
    setHealth_CertificateI(EditStudents?.Health_CertificateI)
    setHealth_CertificateC(EditStudents?.Health_CertificateC)
    setTwo_Passport_Size_PhotographsI(
      EditStudents?.Two_Passport_Size_PhotographsI
    )
    setTwo_Passport_Size_PhotographsC(
      EditStudents?.Two_Passport_Size_PhotographsC
    )
    setReturned_Signed_Declaration_FormsI(
      EditStudents?.Returned_Signed_Declaration_FormsI
    )
    setReturned_Signed_Declaration_FormsC(
      EditStudents?.Returned_Signed_Declaration_FormsC
    )
    setHeadmasterssignature(EditStudents?.headmaster_Signature)
    sethead_Teacher_signed_by(EditStudents?.head_Teacher_signed_by)
    setComment(EditStudents?.Comment)
  }, [
    EditStudents?.firstname,
    EditStudents?.Surname,
    EditStudents?.Gender,

    EditStudents?.Date_Of_Birth,
    EditStudents?.Place_Of_Birth,
    EditStudents?.Mother_Tongue,
    EditStudents?.Religion_And_Denomination,
    EditStudents?.Ghanaian_Language_Spoken,
    EditStudents?.Home_Town,
    EditStudents?.Nationality,
    EditStudents?.Region,
    EditStudents?.Year_In_Which_Admission_Is_Sought,

    EditStudents?.Name_Of_School,
    EditStudents?.Admittion_details,
    EditStudents?.Last_Attendance_Date,
    EditStudents?.How_Did_You_Hear_About_Trinity_Christian_Mission_School,
    EditStudents?.What_Are_Your_Reasons_For_Leaving_Your_Previous_School,

    EditStudents?.Both_Parents,
    EditStudents?.Mother,
    EditStudents?.Father,
    EditStudents?.Other_Person,
    EditStudents?.Guardian,

    EditStudents?.Older_Children,
    EditStudents?.Younger_Children,

    EditStudents?.Details_Of_Persons_Relationship_To_The_Child_Living_with,

    EditStudents?.fathers_Firstname,
    EditStudents?.fathers_surname,
    EditStudents?.fathers_Occupation,
    EditStudents?.fathers_Nationality,
    EditStudents?.fathers_Education_level,

    EditStudents?.fathers_Religion,
    EditStudents?.fathers_Name_And_Adress_Of_Place_Of_Work,
    EditStudents?.fathers_Home_Address,

    EditStudents?.fathers_Tel_Number_Office,
    EditStudents?.fathers_Tel_Number_Mobile,

    EditStudents?.fathers_Email_Address,
    EditStudents?.fathers_Number_Of_Wifes,
    EditStudents?.fathers_If_Deceased_State_Date_Of_Death,

    EditStudents?.Smallpox.checked,
    EditStudents?.Diptheria,
    EditStudents?.Whooping_Cou,
    EditStudents?.Teta,
    EditStudents?.Measles,
    EditStudents?.Polio,
    EditStudents?.Tuberculosis,
    EditStudents?.Further_details_About_the_Childs_Health,
    EditStudents?.In_Case_Of_Sudden_Illness_At_School_Please_State_What_Should_Be_Done,
    EditStudents?.Mother_Firstname,
    EditStudents?.Mother_surname,
    EditStudents?.Mother_Occupation,
    EditStudents?.Mother_Nationality,
    EditStudents?.Mother_Education_level,

    EditStudents?.Mother_Religion,
    EditStudents?.Mother_Name_And_Address_Of_Place_Of_Work,
    EditStudents?.Mother_Home_Adress,

    EditStudents?.Mother_Tel_Number_Office,
    EditStudents?.Mother_Tel_Number_Mobile,

    EditStudents?.Mother_Email_Address,
    EditStudents?.Mother_If_Deceased_State_Date_Of_Death,

    EditStudents?.Guardian_Firstname,
    EditStudents?.EditStudents?.Guardian_surname,
    EditStudents?.Guardian_Occupation,
    EditStudents?.Guardian_Nationality,
    EditStudents?.Guardian_Education_level,
    EditStudents?.Guardian_Religion,
    EditStudents?.Guardian_Name_And_Address_Of_Place_Of_Work,
    EditStudents?.Guardian_Home_Address,

    EditStudents?.Guardian_Tel_Number_Office,
    EditStudents?.Guardian_Tel_Number_Mobile,

    EditStudents?.Guardian_Email_Address,
    EditStudents?.Guardian_Number_Of_Wifes,
    EditStudents?.Parents_or_guardian_signature,
    EditStudents?.ParentsignedBy,
    EditStudents?.correspondence_No,
    EditStudents?.Admission,
    EditStudents?.Date_For_Receipt_Of_Admission_Form,

    EditStudents?.Birth_CertificateI,
    EditStudents?.Birth_CertificateC,
    EditStudents?.Health_CertificateI,
    EditStudents?.Health_CertificateC,
    EditStudents?.Two_Passport_Size_PhotographsI,
    EditStudents?.Two_Passport_Size_PhotographsC,
    EditStudents?.Returned_Signed_Declaration_FormsI,
    EditStudents?.Returned_Signed_Declaration_FormsC,
    EditStudents?.headmaster_Signature,
    EditStudents?.head_Teacher_signed_by,
    EditStudents?.Comment,
  ])

  return (
    <section className='section1'>
      <p>{errMsg}</p>
      <div className='registeration_form_header1'>
        <div className='division00'>
          <div className='wrapper'>
            <h1 className='bold'>Trinity Christian School</h1>
            <h3 className='box'> P.O.BOX 229,NSOATRE,BONO-GHANA</h3>
            <h4>
      ...
      <div className='div1'>
        ...
        <input
          ...
          required
          onChange={(e) => setYear_In_Which_Admission_Is_Sought(e.target.value)}
        />
      </div>
      <br />
      <br />
      ...
      <div className='secondDiv'>
        ...
        <label htmlFor='Details_Of_Persons_Relationship_To_The_Child_Living_with'>
          If Child Lives With Other Person,Please Give Details Of That Person To
          The Child :
        </label>
        <br />
        <input
      ...
      <div className='div4'>
        ...
        <textarea
          ...
          className='textareas'
          value={Further_details_About_the_Childs_Health}
          onChange={(e) =>
            setFurther_details_About_the_Childs_Health(e.target.value)
          }
        />
        <br />
      ...
      <div>
        ...
        <br />
        <br />
        <label className='Mother_Home_Adress'>Home Address(Direction) :</label>
        <br />
        <textarea
          type='text'
          required
      ...
      <div>
        ...
        <h2 className='confirmation'>
          I confirm that,to the best of my knowledge,the information supplied on
          this form is accurate and i agree to abide by the school/s Rules and
          Regulations.
        </h2>
        <br />
      ...
      <button
        className='btn'
        onClick={() => handleUpdate(EditStudents.student_id)}
      >
        submit{' '}
      </button>
    </section>
